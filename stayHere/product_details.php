...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>House Information</h4>
               <table class="table table-bordered">
				<tbody>
				<tr class="techSpecRow"><th colspan="2">House Amenities</th></tr>
				  <?php 
	 ...
	 $ameID1=mysqli_query($connect,"select count(amenity_id) from amenities ");
     $ameID2=mysqli_fetch_array($ameID1);
     $ameID3=$ameID2[0];
	 
	     
	  for($i=0;$i<$ameID3;$i++){
		  
	 $allID1=mysqli_query($connect,"select * from house_amenity where  house_id='$maxhouseID3' and amenity_id='$i' ");
     $allID2=mysqli_fetch_array($allID1);
     $allID3=$allID2[0];
	 
	 $amenity1=mysqli_query($connect,"select facility from amenities where  amenity_id='$i' ");
     $amenity2=mysqli_fetch_array($amenity1);
     $amenity3=$amenity2[0];
		  if($allID3!=null){
	 ?>
				<tr class="techSpecRow"><td class="techSpecTD1"><?php echo $amenity3;?></td><td class="techSpecTD2">Yes</td></tr>
			<?php } 
			}?>
				</tbody>
				</table>
...
<?php
 if(isset($_POST['booknow'])){
     ...
     $curDate1=mysqli_query($connect,"select curDate()");
     $curDate2=mysqli_fetch_array($curDate1);
     $curDate3=$curDate2[0];
	 	  
                if(($availableroom>=$numofrooms)&&($availableroomfromoutdate>=$numofrooms)){
				  if(($indate<=$outdate)&&($curDate3<=$indate)){
     ...
     mysqli_query($connect, $search_Query2); 
	             ...
	             echo 'alert("Incorrect time period!!!")';
	              echo '</script>';	
				}
