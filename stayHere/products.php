...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
			...
			<div class="span6">
                ...
                <a class="btn btn-small pull-right" href="#detail">More Details</a><br>
                 ...
                 <a href="#login" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">Book Now</span></a>
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Customer Details</h4>
               <table class="table table-bordered">
                ...
                <tr class="techSpecRow"><td class="techSpecTD1">Customer NIC</td><td class="techSpecTD1">Phone</td><td class="techSpecTD2">Booked Rooms</td><td class="techSpecTD1">Check In Date</td><td class="techSpecTD1">Check Out Date</td></tr>
                  <?php 
	...
	$hosthousefortest1=mysqli_query($connect,"select * from customerbooking where   house_id='$maxhouseID3' and outdate>=curDate()");
	   while($row = mysqli_fetch_assoc($hosthousefortest1)) {
	              $ni=$row['nic'];
	             $phone1=mysqli_query($connect,"select phone from customer where nic='$ni'");
                 $phone2=mysqli_fetch_array($phone1);
                 $phone3=$phone2[0];
	 
	 
		  
	 ?>
				<tr class="techSpecRow"><td class="techSpecTD1"><?php echo $row['nic'];?></td><td class="techSpecTD1"><?php echo $phone3;?></td><td class="techSpecTD2"><?php echo $row['numofrooms'];?></td><td class="techSpecTD1"><?php echo $row['Indate'];?></td><td class="techSpecTD1"><?php echo $row['outdate'];?></td></tr>
			<?php
	   }
			?>
				</tbody>
