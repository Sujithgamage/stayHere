...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
			...
			<div class="span6">
               ...
               <select class="srchTxt" name="otype">
                     <option>Full House</option>
			          <option>Not Full</option>
                      
		              </select> <br>
               <input type="text" name="bedrooms" required placeholder="Bed Rooms"><br>
               <input type="text" name="bedsinaroom" required placeholder="Beds in a Rooms"><br>
               <input type="text" name="bathrooms" required placeholder="BathRooms"><br>
               <input type="text" name="pricerooms" required placeholder="Price of a Rooms(LKR)"><br>
               <input type="submit" name="edit" required value="Edit" class="btn btn-primary"><br>
               </form>
              
            <?php /*  <h4>Remove Your House</h4>
               <form method="post">
                      <input type="text" name="nicde" required placeholder="Bed Rooms"><br>
                     <input type="password" name="password" required placeholder="Beds in a Rooms"><br>
			   ...
			   if(isset($_POST['edit'])){
                   ...
                   $row=mysqli_fetch_assoc($All1);
				   $hid=$row['house_id'];
				    $Allofd=mysqli_query($connect,"select * from customerbooking where house_id='$hid'  and  outdate>curDate()");
                   $rowofd=mysqli_fetch_assoc($Allofd);
				   
				   
				   $type=$_POST['otype'];
				   $bedrooms=$_POST['bedrooms'];
				   $bedsinaroom=$_POST['bedsinaroom'];
				   $bathrooms=$_POST['bathrooms'];
				   $pricerooms=$_POST['pricerooms'];
				 
				 if($rowofd['house_id']==null){   
				  $search_Query3="Update house set offer='$type', bedrooms='$bedrooms',num_of_beds='$bedsinaroom', num_of_bathrooms='$bathrooms',price='$pricerooms'  where address='$addressof' ";
        mysqli_query($connect, $search_Query3);  
				}
				
				 else {
	  echo '<script language="javascript">';
	  echo 'alert("Don not Change Customer Waiting for this house!!!")';
	  echo '</script>';
	}
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Customer Details</h4>
               <table class="table table-bordered">
				<tbody>
				<tr class="techSpecRow"><th colspan="2">Below Customers waiting for you</th></tr>
				
                <tr class="techSpecRow"><td class="techSpecTD1">Customer NIC</td><td class="techSpecTD2">Booked Rooms</td><td class="techSpecTD1">Check In Date</td><td class="techSpecTD1">Check Out Date</td></tr>
                  <?php 
	...
	$hosthousefortest1=mysqli_query($connect,"select * from customerbooking where   house_id='$maxhouseID3' and outdate>=curDate()");
	   while($row = mysqli_fetch_assoc($hosthousefortest1)) {
	 ...
	 ?>
				<tr class="techSpecRow"><td class="techSpecTD1"><?php echo $row['nic'];?></td><td class="techSpecTD2"><?php echo $row['numofrooms'];?></td><td class="techSpecTD1"><?php echo $row['Indate'];?></td><td class="techSpecTD1"><?php echo $row['outdate'];?></td></tr>
			<?php
	   }
			?>
				</tbody>
